...
class GridPropertiesMixin:
    ...
    def _is_grid_data_multi_z(self) -> bool:
        ...
        """
        # if z is an array that means we are dealing with a multi-z grid and all the fields are 4D: redhsift, x, y, z
    ...
    def _compute_dTb(self, z, temp, x_tot, delta_b, x_HII):
        """
        ...
        if self._is_grid_data_multi_z():
            ...
            for i, z_i in enumerate(z):
                grid[i] = dTb_fct(z=z_i, Tk=temp[i, ...], xtot=x_tot[i, ...], delta_b=delta_b[i, ...], x_HII=x_HII[i, ...], parameters=self.parameters)
    ...
    def Grid_dTb(self):
        ...
        return self._compute_dTb(z, temp, x_tot, delta_b, x_ii)
    ...
    def Grid_dTb_no_reio(self):
        ...
        return self._compute_dTb(z, temp, x_tot, delta_b, 0)
    ...
    def Grid_dTb_T_sat(self):
        ...
        return self._compute_dTb(z, 1e50, 1e50, delta_b, x_ii)
